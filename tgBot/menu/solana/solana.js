...
const CAPTION_SOLANA = "🚀Here you can create Solana wallets and engage in trading between them to increase the volume of the token.\n Please choose one to create or swap.";

const SolanaInputMainKeyboard = new InlineKeyboard()
        .row().text("Manage Main Wallet", "solana_input_manage_main_wallet")
        .row().text("Manage Sub Wallets", "solana_input_manage_sub_wallets")
        .row().text("Swap on Sub Wallets", "solana_input_swap_on_sub_wallets")
        .row().text("Back To Main", "back_to_first");
