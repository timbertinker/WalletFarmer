...
const CAPTION_SOLANA_MANAGE_MAIN_WALLET =
...
const SolanaManageMainWalletKeyboard = new InlineKeyboard()
  .row()
  .text("Create Main Wallet", "solana_input_create_main_wallet")
  .row()
  .text("Deposit", "solana_input_deposite_main_wallet")
  .text("Withdraw", "solana_input_withdraw_main_wallet")
  .row()
  .text("Check Main Wallet", "solana_input_check_main_wallet")
  .row()
  .text("Back To Main", "back_to_solana");
