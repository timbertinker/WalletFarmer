...
const CAPTION_UNISWAP =
  "🦄Here you can create Uniswap wallets and engage in trading between them to increase the volume of the token.\n Please choose one to create or swap.";

const UniswapKeyboard = new InlineKeyboard()
  .row()
  .text("Manage Main Wallet", "uniswap_input_manage_main_wallet")
  .row()
  .text("Manage Sub Wallets", "uniswap_manage_sub_wallet")
  .row()
  .text("Swap on Sub Wallets", "uniswap_swap_on_sub_wallet")
  .row()
