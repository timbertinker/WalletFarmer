...
const CAPTION_UNISWAP_CREATE = "❓How many wallet would you like to create?\n💡We will create randomized wallet for you.";

const UniswapInputWalletCountKeyboard = new InlineKeyboard()
        .row().text("Create Sub Wallets", "uniswap_create_sub_wallets")
        .row().text("Default Amount", "uniswap_default_amount")
        .row().text("Deposit",  "uniswap_deposite_sub_wallets").text("Wrap", "uniswap_input_wrap_sub_wallets")
        .row().text("Check Sub Wallets", "uniswap_check_sub_wallets")
