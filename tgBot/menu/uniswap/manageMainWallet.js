...
const CAPTION_MANAGE_UNISWP_MAIN_WALLET =
  "🦄Here you can manage your main wallet🦄\n You can deposit to your main wallet from your personal wallet or withdraw from main wallet to your personal wallet.\n";

const UniswapManageMainwallet = new InlineKeyboard()
  .row()
  .text("Create Main Wallet", "uniswap_input_create_main_wallet")
  .row()
  .text("Deposit", "uniswap_input_deposit_main_wallet")
  .text("Withdraw", "uniswap_input_withdraw_main_wallet")
  .row()
  .text("Check Main Wallet", "uniswap_input_check_main_wallet")
  .row()
  .text("Back", "back_to_uniswap");

export const returnToManageMainWallet = async (tgBot, ctx, isCallbackQuery = false) => {
